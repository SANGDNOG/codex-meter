...
3. Add Device A to Group A and run its one-line installer on machine A. Confirm `codex-meter-agent status` and Dashboard Online state.
4. Add Device B to Group B and install on machine B in the same way.
