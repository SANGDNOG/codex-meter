...
function dashboard(data) {
  ...
  return `<!doctype html><meta charset="utf-8"><title>Codex Meter</title><style>body{font:16px system-ui;max-width:900px;margin:2rem auto}table{border-collapse:collapse}td,th{padding:.5rem;border:1px solid #bbb}</style><h1>Codex Meter</h1><p>Equal quota: ${data.config.quotaTokens} tokens</p><table><thead><tr><th>User</th><th>Enabled</th><th>Total tokens</th></tr></thead><tbody>${rows}</tbody></table>`;
}
